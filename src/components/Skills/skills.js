...
const Skills = () => {
  return (
    <section id="skills">
      ...
      <span className="skillDesc">Highly skilled Artificial Intelligence and Data Science student and an expert frontend web developer with a passion for creating robust and innovative softwares.</span>
